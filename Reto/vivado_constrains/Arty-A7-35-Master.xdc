...
## Switches
#set_property -dict { PACKAGE_PIN A8    #IOSTANDARD LVCMOS33 } [get_ports { DIGITO[0] }]; #IO_L12N_T1_MRCC_16 Sch=sw[0]
#set_property -dict { PACKAGE_PIN C11   #IOSTANDARD LVCMOS33 } [get_ports { DIGITO[1] }]; #IO_L13P_T2_MRCC_16 Sch=sw[1]
#set_property -dict { PACKAGE_PIN C10   #IOSTANDARD LVCMOS33 } [get_ports { DIGITO[2] }]; #IO_L13N_T2_MRCC_16 Sch=sw[2]
#set_property -dict { PACKAGE_PIN A10   #IOSTANDARD LVCMOS33 } [get_ports { DIGITO[3] }]; #IO_L14P_T2_SRCC_16 Sch=sw[3]
...
## Pmod Header JA
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { ss_n }]; #IO_0_15 Sch=ja[1]
...
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { s_clk }]; #IO_L6P_T0_15 Sch=ja[4]
...
## Pmod Header JB
#set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { SEGMENTOS[0] }]; #IO_L11P_T1_SRCC_15 Sch=jb_p[1]
#set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { SEGMENTOS[1] }]; #IO_L11N_T1_SRCC_15 Sch=jb_n[1]
#set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { SEGMENTOS[2] }]; #IO_L12P_T1_MRCC_15 Sch=jb_p[2]
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { SEGMENTOS[3] }]; #IO_L12N_T1_MRCC_15 Sch=jb_n[2]
...
## Pmod Header JC
#set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { SEGMENTOS[4] }]; #IO_L20P_T3_A08_D24_14 Sch=jc_p[1]
#set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { SEGMENTOS[5] }]; #IO_L20N_T3_A07_D23_14 Sch=jc_n[1]
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { SEGMENTOS[6] }]; #IO_L21P_T3_DQS_14 Sch=jc_p[2]
#set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { CONTROL }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=jc_n[2]
